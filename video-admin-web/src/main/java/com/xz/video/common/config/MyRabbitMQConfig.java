package com.xz.video.common.config;
...
public class MyRabbitMQConfig {
     ...
     */
    @Bean
    public Exchange dmEventExchange() {
        return new TopicExchange("dm-event-exchange", true, false);
    }
    /**
     * 死信队列
     */
     ...
     */
    @Bean
    public Queue dmSendQueue(){return new Queue("dm.release.queue", true, false, false);}
    /**
     * 绑定：交换机与订单解锁延迟队列
     */
    @Bean
    ...
    public Binding dmSendBinding() {
         ...
         * Map<String, Object> arguments
         **/
        return new Binding("dm.release.queue",
                Binding.DestinationType.QUEUE,
                "dm-event-exchange",
                "dm.send",
                null);
