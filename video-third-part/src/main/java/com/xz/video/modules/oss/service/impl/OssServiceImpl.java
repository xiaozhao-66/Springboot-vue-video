package com.xz.video.modules.oss.service.impl;
...
import com.xz.video.modules.oss.utils.VideoUtil;
...
//            meta.setContentType("image/jpg");
    ...
    @Override
    public Map<String, String> uploadVideoFile(MultipartFile file) {
        Map<String, String> map = new HashMap<>();
        String url = uploadFileAvatar(file);
        String duration = VideoUtil.getDurationBackString(file);
        map.put("url", url);
