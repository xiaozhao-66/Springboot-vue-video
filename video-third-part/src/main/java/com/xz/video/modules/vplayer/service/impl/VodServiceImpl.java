package com.xz.video.modules.vplayer.service.impl;
...
import com.xz.video.modules.vplayer.Utils.ConstantVodUtils;
import com.xz.video.modules.vplayer.Utils.InitVodCilent;
...
//        }
    ...
    public String getPlayAuth(String id) {
        try {
            ...
            throw new RenException(2001, "获取凭证失败");
        }
    }
