...
<div class="off-canvas-wrapper">
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper="">
        ...
        <div class="off-canvas-content" data-off-canvas-content="">
            ...
            <!-- profile top section -->
            <section class="topProfile topProfile-inner" style="background: url('static/image/profile-bg1.png') no-repeat;">
                <div class="main-text">
                    <div class="row">
                        <div class="large-12 columns">
                    ...
                    <div class="row secBg">
                        <div class="large-12 columns">
                            <div class="profile-author-img">
                                <img src="static/picture/profile-auth-img.png" alt="profile author img">
                            </div>
                            ...
                            <div class="large-12 columns">
                                <div class="widgetBox">
                                    ...
                                    <div class="widgetContent">
                                        ...
                                        <a href="" class="button"><i class="fa fa-plus-circle"></i>Submit Video</a>
                                    </div>
                                </div>
...
//@import '../../../assets/css/jquery.kyco.easyshare.css';
